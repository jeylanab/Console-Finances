...
// Declare Variables to store Changes and sum of Changes
...
for (var i = 1; i < finances.length; i++) {
  ...
  // Change in Profit/Lose within a month
  ...
  // Adding Profit/Lose of Every Months
...
var AverageChange = SumOfChanges / (TotalMonths - 1);
...
console.log("Greatest increase in Profit/Losses:" ,maxIncreaseDate ,"($",maxIncreaseAmount,")" );


// Minimum Amount 

var minDecreaseDate = '';
var minDecreaseAmount = 0;
...
for (var i = 1; i < finances.length; i++) {
    ...
    // Check if the current change is less than the previous minimum
    if (change < minDecreaseAmount) {
        minDecreaseDate = finances[i][0];
        minDecreaseAmount = change;
    }
}
